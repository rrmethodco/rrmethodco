    ...
    <div className="space-y-8">
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/practice/inbox" className="btn-secondary">
            <Inbox size={16} />
            Inbox
            {pendingCount > 0 && (
        ...
        <>
          ...
          <section className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="card overflow-hidden">
              <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                ...
                <Link href="/practice/inbox" className="inline-flex items-center gap-1 text-xs font-medium text-brand-700 hover:text-brand-800">
                  Review all
                  <ArrowRight size={12} />
                </Link>
              </div>
            ...
            <div className="card overflow-hidden">
              <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                ...
                <Link href="/practice/history" className="inline-flex items-center gap-1 text-xs font-medium text-brand-700 hover:text-brand-800">
                  View history
                  <ArrowRight size={12} />
                </Link>
              </div>
          ...
          <section className="card p-5">
            <div className="flex items-center justify-between">
              ...
              <Link href="/practice/cases" className="inline-flex items-center gap-1 text-xs font-medium text-brand-700 hover:text-brand-800">
                See all cases
                <ArrowRight size={12} />
              </Link>
            </div>
        ...
        <>
          ...
          <section className="card p-6">
            <div className="flex items-center justify-between">
              ...
              <Link href="/practice/playbook" className="inline-flex items-center gap-1 text-xs font-medium text-brand-700 hover:text-brand-800">
                Open playbook
                <ArrowRight size={12} />
              </Link>
            </div>
